...
$lang['system_dialog_pluginInstallation_actionDescription']         = 'After selecting a plugin the selected *.zip-file will be uploaded and installed to the server ';
$lang['system_dialog_pluginInstallation_buttonLabelChoose']         = 'Select File';
$lang['system_dialog_pluginInstallation_buttonLabelClose']          = 'Close';
$lang['system_dialog_pluginInstallation_buttonLabelCancel']         = 'Cancel';

//dialog install plugin error-/successMessages
$lang['system_dialog_pluginInstallation_errorCantOpenZIP']          = 'Can not open zip-archive.';
$lang['system_dialog_pluginInstallation_errorCantUploadFile']       = 'Cant upload file.';
$lang['system_dialog_pluginInstallation_successPluginInstalled']    = 'Plugin was installed successfully.';
?>